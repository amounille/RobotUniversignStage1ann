...
namespace RobotUniversign.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class EnvoyerPourSignatureController : ControllerBase
    {
        private ConfDW _cdw;
        
        private DatabaseContext _bdd;
        private readonly ILogger<EnvoyerPourSignatureController> _logger;
        public EnvoyerPourSignatureController(ILogger<EnvoyerPourSignatureController> logger, IDBService Bdd)
        {
            _logger = logger;
        ...
        public Retour Post([FromBody] InputDataSignature Data)
        {
            ...
            try
            {
                ...
                {
                    profile = "default",
                    signers = new TransactionSigner[1],
                    documents = new TransactionDocument[1],
                    certificateTypes = new string[1],
                ...
                trans.signers[0] = new TransactionSigner()
                {
                    firstname = Data.Destinataire.Prenom,
                    lastname = Data.Destinataire.Nom,
                    emailAddress = Data.Destinataire.Email,
                    signatureField = new Universign_pck.Models.SignatureField()
                    {
                        page = Data.Destinataire.Signature.Page,
                        x = Data.Destinataire.Signature.X,
                        y = Data.Destinataire.Signature.Y,
                    }
                };
                ...
                trans.certificateTypes[0] = Data.Destinataire.Certificat;
